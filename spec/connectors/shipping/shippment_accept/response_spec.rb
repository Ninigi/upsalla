...
RSpec.describe Upsalla::Connectors::ShipmentAccept do
  describe "#request#response" do
    context "when successfull" do
              ...
              <ShipmentResults>
                  ...
                  <PackageResults>
                      ...
                      <LabelImage>
                          ...
                          <GraphicImage>IMAGESTRING</GraphicImage>
                          <HTMLImage>HTMLIMAGESTRING</HTMLImage>
                      </LabelImage>
                  </PackageResults>
              </ShipmentResults>
          </ShipmentAcceptResponse>
      ...
      let!(:request) do
        ...
        subject.request Upsalla::Connection::TEST_URL, test_digest
      end
        ...
        expected_response = {
          "ShipmentAcceptResponse" => {
            ...
            "ShipmentResults" => {
              ...
              "ShipmentIdentificationNumber" => "1Z2220060292353829",
              "PickupRequestNumber" => "297BL02P1A3",
              "PackageResults" => {
                "TrackingNumber" => "1Z2220060292353829",
                "ServiceOptionsCharges" => {
                  "CurrencyCode" => "USD",
                  "MonetaryValue" => "0.00"
                },
                "LabelImage" => {
                  ...
                  "GraphicImage" => "IMAGESTRING",
                  "HTMLImage" => "HTMLIMAGESTRING"
                }
              }
            }
          }
  ...
  context "when error" do
    let(:test_digest) do
      {
        shipment_digest: "invalid-Digest"
      }
    end
    ...
    describe "#response" do
      it "should return the response as a <#Hash> with the original keys", pending: true do
        expected_response
    ...
    describe "#parsed_response" do
      it "should return a more concise version of #response", pending: true do
        expected_response
